<html lang="en">
  <head>
    ...
    <!-- fontawesome -->
    <link rel="stylesheet" href="./bootstrap-5.1.3/all.min.css"/>
    <!-- bootstrap -->
  ...
  <body class="bg-gray">
    ...
    <div class="container mt-5 pt-5 d-flex flex-column flex-lg-row justify-content-evenly">
      ...
      <div class="text-center text-lg-start mt-0 pt-0 mt-lg-5 pt-lg-5">
        <h1 class="text-primary fw-bold fs-0">Felix</h1>
        <p class="w-75 mx-auto fs-4 mx-lg-0">Felix helps you connect and share with the people in your life.</p>
      </div>
      <!-- form card -->
    ...
    <footer class="bg-white p-4 text-muted">
      <div class="container">
        ...
        <!-- copy -->
        <div class="mt-4 mx-2">
          <p class="fs-7">Felix &copy; 2021</p>
        </div>
      </div>
    </footer>
