<div class="bg-white p-4 rounded shadow mt-3">
      ...
      <?php include ('edit_post.php'); ?>
              ...
              <div class="mt-3">
                <!-- content -->
                <div class="bg-white" style="background-color: <?= $post['bg_color']; ?>">
                  ...
                  <audio
                    src="<?= "public/audios/".$user['guid']."/".$post['name'] ?>"
                    alt="audio,since <?= $post['date_upload']; ?>"
                    title="audio,since <?= $post['date_upload']; ?>"
