<?php include_once('include.php');
 ...
 ?>
  ...
  <body class="bg-dark text-white postion-relative">
    <!-- ================= Appbar ================= -->
    <div
      class="bg-dark text-white d-flex align-items-center fixed-top shadow"
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col d-flex align-items-center">
            ...
            <i class="fab rounded me-2shadow" style='width: 40px; height: 40px;text-align:center;color:white;border-radius:100px;font-size: 2em;font-family: Roman;background: rgb(2,0,36);
background: linear-gradient(120deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 35%, rgba(0,212,255,1) 100%);'>M</i>
            <!-- search bar -->
            <div class="input-group ms-2" type="button">
              ...
              >
                <div
                  class="input-group-text bg-dark text-white border-0 rounded-circle"
              ...
              >
                <div
                  class="input-group-text bg-dark text-white border-0 rounded-pill"
              ...
              >
                ...
                <li>
                  <input
                    type="text"
                    class="rounded-pill border-0 bg-dark text-white dropdown-item"
          ...
          <div class="col d-flex align-items-center justify-content-end">
              ...
              <div>
                ...
                <li class="p-1">
                  ...
                  >
                    ...
                    <input
                      type="text"
                      class="form-control rounded-pill border-0 bg-dark text-white"
            ...
            >
              ...
              <li class="p-1">
                ...
                <div class="d-flex" type="button">
                  <p class="rounded-pill bg-dark text-white p-2">All</p>
            ...
            >
              ...
              >
                <i
                  class="fas fa-exclamation-circle bg-dark text-white p-2 rounded-circle"
                ></i>
                <div class="ms-3">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <div class="d-flex" data-bs-toggle="dropdown">
                      <i class="fas fa-cog bg-dark text-white p-2 rounded-circle"></i>
                      <div
                        class="
                          ms-3
                          d-flex
              ...
              <li class="dropdown-item p-1 my-3 rounded" type="button">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <div class="d-flex" data-bs-toggle="dropdown">
                      <i class="fas fa-moon bg-dark text-white p-2 rounded-circle"></i>
                      <div
                        class="
                          ms-3
                          d-flex
        ...
        <div class="modal-content border-0 shadow">
          ...
          <div class="modal-body p-0 overflow-auto" style="max-height: 300px">
            ...
            <li class="list-group-item border-0 d-flex">
              ...
              <!-- message -->
              <p class="bg-dark text-white p-2 rounded">Lorem, ipsum dolor</p>
            </li>
            <!-- message r -->
                      ...
                      <div class="modal-body">
                        ...
                        <li class="my-1 p-1">
                          ...
                          >
                            ...
                            <select
                              class="form-select w-50 border-0 bg-dark text-white"
        ...
        <div class="col-12 col-lg-6 pb-5">
          ...
          >
            ...
            <div class="mt-5 d-flex justify-content-between position-relative">
              <!-- s 1 -->
              <div
                class="mx-1 bg-dark text-white rounded story"
                type="button"
            ...
            <!-- create post -->
            <div class="bg-dark text-white p-3 mt-3 rounded border shadow">
              <!-- avatar -->
              <div class="d-flex" type="button">
                <div class="p-1">
                  <img
                ...
                <input
                  type="text"
                  class="form-control rounded-pill border-0 bg-dark text-white pointer"
                  disabled
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div>
                              ...
                              <select
                                class="form-select border-0 bg-dark text-white w-75 fs-7"
                                aria-label="Default select example"
                              >
            ...
            <!-- posts -->
            <!-- p 1 -->
            <div class="bg-dark text-white p-4 rounded shadow mt-3">
              <!-- author -->
              <div class="d-flex justify-content-between">
                <!-- avatar -->
                <div class="d-flex">
                        ...
                        <div class="accordion-body">
                          ...
                          <div class="d-flex align-items-center my-1">
                            ...
                            <div class="p-3 rounded comment__input w-100">
                              ...
                              <p class="fw-bold m-0"><?= $_SESSION['name']." ".$_SESSION['surname'] ?></p>
                              <p class="m-0 fs-7 bg-dark text-white p-2 rounded">
                          ...
                          <form class="d-flex my-1">
                            ...
                            <input
                              type="text"
                              class="form-control border-0 rounded-pill bg-dark text-white"
    ...
    <div
      ...
      data-bs-target="#newChat"
    >
      <i class="fas fa-edit bg-dark text-white rounded-circle p-3 shadow"></i>
    </div>
